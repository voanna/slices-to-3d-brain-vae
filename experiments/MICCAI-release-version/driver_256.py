...
train_all_sh = os.path.join(scripts_dir, 'train_all_128.sh')
    ...
    for learning_rate in learning_rates:
        for batch_size in batch_sizes:
            for kl_latent_loss_weight in kl_latent_loss_weights:
                ...
                pycmd = 'python experiments/{}/main_experiment_256.py ' \
                        ' --learning-rate={}' \
                ...
                g.write(
                    'qsub -l gpu -l h_vmem={}G -l h_rt=24:00:00 -j y -o '.format(40) + logfile + ' ' + shname + '\n')
