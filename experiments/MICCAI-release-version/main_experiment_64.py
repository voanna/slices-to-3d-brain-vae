...
class Encoder(nn.Module):
    def __init__(self, n_channels, gf_dim=16):
        ...
        self.res6 = ResBlockDown(gf_dim * 8, gf_dim * 16, act=False)
        self.res2_stdev = ResBlockDown(gf_dim * 8, gf_dim * 16, act=False)
...
mri_data_dir = '/scratch_net/biwinator02_third/voanna/curvature/data/MRI_slices_64_isotropic'
...
def main(args):
    ...
    encoder = Encoder(args.n_channels, gf_dim=16)
    decoder = Decoder(args.n_channels, gf_dim=16)
